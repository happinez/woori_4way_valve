...
volatile l_signals_t l_signals = {
    ...
    .d_valve_status = 0x00u,
    .d_motor_status = 0x00u,
    .d_debug_1 = 0x0000u,
    .d_debug_2 = 0x00u
};
...
/*
 * Unconditional frame Debug_Frame
 */
typedef struct ATTR_PACKED {
    l_u8 sig_d_valve_status  : 8;
    l_u8 sig_d_motor_status  : 8;
    l_u16 sig_d_debug_1  : 16;
    l_u8 sig_d_debug_2  : 8;
    l_u8 unused40  : 8;
    l_u8 unused48  : 8;
    l_u8 unused56  : 8;
...
static const l_s_UnconditionalFrame_t l_sl1_Debug_Frame_frame = {l_sl1_Debug_Frame_handler};
...
const l_s_Frame_t frameList [SL_NUMBER_OF_DYNAMIC_MESSAGES] = {
    ...
    {sft_UnconditionalFrame, (l_s_UnconditionalFrame_t *)&l_sl1_Debug_Frame_frame}
};
